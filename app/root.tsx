...
export const links: LinksFunction = () => {
  return [
    ...
    { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&family=Source+Code+Pro:wght@400;600&family=JetBrains+Mono:wght@600;700&display=auto" },
  ];
};
  ...
  return (
    <html lang="en" className={theme ?? ""}>
      ...
      <body className="bg-body-light dark:bg-body-dark leading-6 text-light dark:text-dark">
        <svg xmlns="http://www.w3.org/2000/svg" href="http://www.w3.org/1999/xlink" id="global-icons" style={{ 'display': 'none' }} className="text-white">
